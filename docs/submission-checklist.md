...
Deadline: August 20, 2026 at 11:59 PM PT

## Complete In Repository

- [x] Track and product are locked.
- [x] HydraDB is the authoritative graph store.
- [x] Deterministic 20-record fixture exists.
- [x] Repeat ingestion is verified.
- [x] Incoming `SSpaths` is verified.
- [x] Hydrated paths are visible.
- [x] Temporal positive and negative cases work.
- [x] No-evidence case works.
- [x] Restart persistence is verified.
- [x] Unit, type, build, loading/error browser, and 10k gates are recorded.
- [x] README documents setup, data, tests, limitations, and HydraDB's role.
- [x] MIT license is present.
- [x] Timed demo script is present.
- [x] Submission text draft is present.
